...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://nickmdbot2255:nickmdbot2255@nick.0rmggjg.mongodb.net/?appName=nick';
        ...
        sock.ev.on('connection.update', async (update) => {
            ...
            if (connection === 'close') {
                ...
                try {
                    ...
                    // --- ANIMATED LOGIN MESSAGE START ---
                    let msg = await sock.sendMessage(jid, { text: '🌐 ᴄᴏɴɴᴇᴄᴛɪɴɢ ᴛᴏ sᴇʀᴠᴇʀ...' });

                    setTimeout(async () => {
                        await sock.sendMessage(jid, { text: '⚡ ɪɴɪᴛɪᴀʟɪᴢɪɴɢ sʏsᴛᴇᴍ...' }, { edit: msg.key });
                    }, 1000);

                    setTimeout(async () => {
                        await sock.sendMessage(jid, { text: '🔐 sᴇᴄᴜʀɪɴɢ sᴇssɪᴏɴ...' }, { edit: msg.key });
                    }, 2000);
