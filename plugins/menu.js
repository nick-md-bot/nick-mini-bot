...
╰━━━━━━━━━━━━━>\n ${readMore}\n\n`;
            ...
            commands.map((command, num) => {
                if (command.name) {
                    let NickName = command.name;
                    Nick = NickName.source.split('\\s*')[1].toString().match(/(\W*)([A-Za-züşiğ öç1234567890]*)/)[2];
                }
                if (command.dontAddCommandList || Nick === undefined) return;
                if (!command.dontAddCommandList && Nick !== undefined) {
                    let category;
                    if (!command.category) {
                        category = "misc";
                    } else {
                    ...
                    return await client.sendMessage(m.jid, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                sourceUrl: "https://github.com/nick.com",
                                mediaType: 1,
                    ...
                    return await client.sendMessage(m.jid, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                body: style(`${config.BOT_INFO.split(";")[0]}`),
                                sourceUrl: "https://github.com/nick.com",
                                mediaUrl: "https://github.com/nick.com",
                                mediaType: 1,
                                showAdAttribution: true,
